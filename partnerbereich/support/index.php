...
$Titel = "BestPrime | Support";
$keywords = "";
$description = "Dein persönlicher Supportbereich";
$lastModified = 'Sun, 07 Nov 2021 15:30 GMT';
$canonical = "/partnerbereich/support"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "support"; // Seitenklasse fürs CSS
//Seitenbeginn
