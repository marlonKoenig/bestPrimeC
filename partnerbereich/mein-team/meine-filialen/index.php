...
$Titel = "BestPrime | Meine Filialen";
$keywords = "";
$description = "Ihr Bereich für eine finanzielle sichere Zukunft";
$lastModified = 'Tue, 14 Sep 2021 20:30 GMT';
$canonical = "/partnerbereich/mein-team/meine-filialen"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "meine-filialen"; // Seitenklasse fürs CSS
//Seitenbeginn
