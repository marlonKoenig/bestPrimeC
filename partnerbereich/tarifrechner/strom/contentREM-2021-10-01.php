        ...
        <div id="powerContainer">
            <div id="offerContainer">
                ...
                <div class="buttonTable">
                    ...
                    <div>
                        <div id="factoryHome" class="auswahlbutton group01" onclick="groupSelector(this, 'group01')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="1" stroke="currentColor" fill="none"><path d="M34.82,52.73H14.69V22.18a1,1,0,0,1,.52-.87L33.34,11.4a1,1,0,0,1,1.48.88Z" stroke-linecap="round"/><path d="M48.87,52.73H34.92V21.59L48.4,29.3a1,1,0,0,1,.47.85Z" stroke-linecap="round"/><line x1="28.1" y1="24.86" x2="21.06" y2="24.86" stroke-linecap="round"/><line x1="43.66" y1="32.41" x2="40.14" y2="32.41" stroke-linecap="round"/><line x1="43.66" y1="36.9" x2="40.14" y2="36.9" stroke-linecap="round"/><line x1="43.66" y1="41.71" x2="40.14" y2="41.71" stroke-linecap="round"/><line x1="43.66" y1="46.19" x2="40.14" y2="46.19" stroke-linecap="round"/><line x1="28.1" y1="30.44" x2="21.06" y2="30.44" stroke-linecap="round"/><line x1="28.1" y1="35.94" x2="21.06" y2="35.94" stroke-linecap="round"/><line x1="28.1" y1="41.44" x2="21.06" y2="41.44" stroke-linecap="round"/><line x1="28.1" y1="46.94" x2="21.06" y2="46.94" stroke-linecap="round"/><line x1="9.46" y1="52.73" x2="54.54" y2="52.73" stroke-linecap="round"/></svg>
                ...
                <div id="stromInput" class="inputContainer">
                    <div id="energietyp">
                        <div class="inputTable">
                            ...
                            <select id="energieTyp" class="selectListe" name="energieTyp">
                    ...
                    <div id="PLZ">
                        <div class="inputTable">
                            ...
                            <input type="text" id="plz" name="plz" onkeyup="checkPLZ()">
                        </div>
                    </div>
                </div>
                <div id="jahresverbrauch" class="inputContainer">
                    <div id="KWH" class="inputTable">
                        ...
                        <input type="text" id="kwh" name="kwh" onkeyup="checkNumber()">
                    </div>
                    <div  id="personenzahl"class="inputTable">
                        ...
                        <div id="personenContainer">
                            <div id="one" class="persons" onclick="checkPersons('1')">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" stroke-width="1" stroke="currentColor" fill="none"><circle cx="32" cy="18.14" r="11.14"/><path d="M54.55,56.85A22.55,22.55,0,0,0,32,34.3h0A22.55,22.55,0,0,0,9.45,56.85Z"/></svg>
                                <div>1</div>
                            </div>
            ...
            <div id="compareContainer">
                ...
                <div id="compareContent">
                    Aktuell liegen noch keine Ergebnisse vor.<br>
                    Bitte vervollständigen Sie die Eingaben auf der linken Seite.
                </div>
            </div>
        </div>
    </div>
