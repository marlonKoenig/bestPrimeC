...
?>
<div id="loadButton" onclick="getDataArray('loadAllOnlineCustomer')">Kundenübersicht laden</div>
...
<div id="descriptionText">Wenn dieser Kunde bei sich auch "Mit Berater verbinden" klickt, kannst Du hier die Daten empfangen:</div>
<div id="connectButton" onclick="connectToCustomer(<?php echo $jsonArray['user_id']; ?>)">Mit Kunden verbinden</div>

<div id="connectButton" class="advisorButton"><a id="viewAdvisor" href="https://jitsi.fem.tu-ilmenau.de/BestPrimeDev-<?php echo $jsonArray['user_id']; ?>" target="blank">Videoanruf mit Kunden</a></div>

<div id="insertEnergyTable"></div>
