...
$Titel = "BestPrime | Auftragsverwaltung";
$keywords = "";
$description = "Dein Bereich für den Übeblick über Dein Ranking";
$lastModified = 'Tue, 09 Nov 2021 15:30 GMT';
$canonical = "/partnerbereich/ranking"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "ranking"; // Seitenklasse fürs CSS
//Seitenbeginn
