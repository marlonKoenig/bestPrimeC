...
$Titel = "BestPrime | Businessrechner";
$keywords = "";
$description = "Berechne Deine individuellen Einkommensmöglichkeiten";
$lastModified = 'Tue, 03 Aug 2021 20:30 GMT';
$canonical = "/partnerbereich/marketingcenter/businessrechner"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "businessrechner"; // Seitenklasse fürs CSS
//Seitenbeginn
