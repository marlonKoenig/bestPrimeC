...
$Titel = "BestPrime | Social Postings";
$keywords = "";
$description = "Erstelle Deine Links für social Media";
$lastModified = 'Tue, 03 Aug 2021 20:30 GMT';
$canonical = "/partnerbereich/socialpost"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "socialpost"; // Seitenklasse fürs CSS
//Seitenbeginn
