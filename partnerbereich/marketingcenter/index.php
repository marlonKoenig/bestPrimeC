...
$Titel = "BestPrime | Marketincenter";
$keywords = "";
$description = "Dein persönlicher Marketingbereich";
$lastModified = 'Tue, 03 Aug 2021 20:30 GMT';
$canonical = "/partnerbereich/marketingcenter"; // Canonical für <head>
$robots = "off"; // Nur für diese Seite! Default ist on, versteckte Seiten erhalten "off"
$site = "marketingcenter"; // Seitenklasse fürs CSS
//Seitenbeginn
