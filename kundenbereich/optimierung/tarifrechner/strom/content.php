<?php
$file_root_path = "../../../../media/users/" . $_SESSION['user_id'] . "/documents/"; //$_SESSION['root'].
$counter = 1;
?>
        ...
        <div id="powerContainer">
            <div id="offerContainer">
                ...
                <div id="lastRow">
                    <div id="yearly" class="">
                        ...
                        <input type="number" id="yearlyCost" name="yearlyCost">
                    </div>
            ...
            <div id="compareContainer">
                ...
                <div id="compareContent">
                    ...
                    <p><small>Das ist natürlich freiwillig, aber wir würden es Dir empfehlen, damit Du später einen besseren Vergleich über Deine Ersparnisse hast.</small></p>
